...
class AgendasControllerTest < ActionController::TestCase
  ...
  test "should create agenda" do
    assert_difference('Agenda.count') do
      post :create, agenda: { data_hora: @agenda.data_hora, informacoes: @agenda.informacoes, publicado: @agenda.publicado, tipo: @agenda.tipo, titulo: @agenda.titulo, user_id: @agenda.user_id }
    end
  ...
  test "should update agenda" do
    patch :update, id: @agenda, agenda: { data_hora: @agenda.data_hora, informacoes: @agenda.informacoes, publicado: @agenda.publicado, tipo: @agenda.tipo, titulo: @agenda.titulo, user_id: @agenda.user_id }
    assert_redirected_to agenda_path(assigns(:agenda))
  end
