...
class DepartamentosControllerTest < ActionController::TestCase
  ...
  test "should create departamento" do
    assert_difference('Departamento.count') do
      post :create, departamento: { email: @departamento.email, nome: @departamento.nome, sigla: @departamento.sigla, telefone: @departamento.telefone }
    end
  ...
  test "should update departamento" do
    patch :update, id: @departamento, departamento: { email: @departamento.email, nome: @departamento.nome, sigla: @departamento.sigla, telefone: @departamento.telefone }
    assert_redirected_to departamento_path(assigns(:departamento))
  end
