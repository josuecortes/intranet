...
class PassengersControllerTest < ActionController::TestCase
  ...
  test "should create passenger" do
    assert_difference('Passenger.count') do
      post :create, passenger: { cpf: @passenger.cpf, matricula: @passenger.matricula, nome: @passenger.nome, respaldo: @passenger.respaldo, tipo: @passenger.tipo }
    end
  ...
  test "should update passenger" do
    patch :update, id: @passenger, passenger: { cpf: @passenger.cpf, matricula: @passenger.matricula, nome: @passenger.nome, respaldo: @passenger.respaldo, tipo: @passenger.tipo }
    assert_redirected_to passenger_path(assigns(:passenger))
  end
