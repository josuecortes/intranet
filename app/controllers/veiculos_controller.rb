class VeiculosController < ApplicationController
  ...
  load_and_authorize_resource :class=>"Veiculo", except: :create
  ...
  private
    ...
    def veiculo_params
      params.require(:veiculo).permit(:tipo, :marca, :modelo, :ano, :cor, :placa, :combustivel, :validade_documento, :capacidade, :carga, :status, :posto_id, :motorista_id)
    end

    def colecoes
      @lista_tipo_veiculos = ['PICK-UP','PASSEIO','CAMINHAO','MOTOCICLETA','MINI VAN','ONIBUS']
      @lista_tipo_combustivel = ['GASOLINA','ALCOOL','DISEL','GASOLINA/ALCOOL']
      @lista_status_veiculo = ['FORA','DISPONIVEL','EM SERVICO']
